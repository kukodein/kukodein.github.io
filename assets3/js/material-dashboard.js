...
let classNameHide = 'g-sidenav-desktop-hide';

const gIconNavbarSidenav = iconNavbarSidenav.querySelector('.material-symbols-rounded');
...
function toggleSidenav() {
	...
	if (body.classList.contains(classNameHide)) {
		gIconNavbarSidenav.textContent = 'menu';
		// setTimeout(function() {
		// 	sidenav.classList.remove('bg-white');
		// }, 100);
		// sidenav.classList.remove('bg-transparent');
	} else {
		gIconNavbarSidenav.textContent = 'segment';
	...
	if (window.innerWidth > 1200) {
		if (body.classList.contains(classNameHide)) {
			body.classList.remove(classNameHide);
			// setTimeout(function() {
			// 	sidenav.classList.remove('bg-white');
			// }, 100);
			// sidenav.classList.remove('bg-transparent');
		} else {
			body.classList.add(classNameHide);
			// sidenav.classList.add('bg-white');
			// sidenav.classList.remove('bg-transparent');
			// iconSidenav.classList.remove('d-none');
		}
